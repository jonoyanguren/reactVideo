...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoDetail = __webpack_require__(176);
	...
	var API_KEY = 'AIzaSyChN5frBeiJMXvCxx49hSrUSpRSmpA-Iws';
	...
	var App = function (_React$Component) {
	    ...
	    function App() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            ...
	            //     });
	            // });
	        }, _this.videoSelect = function (video) {
	            if (video) {
	                _this.setState({ selectedVideo: video });
	                console.log("Select video");
	            }
	        }, _this.videoSearch = function (value) {
	            (0, _youtubeApiSearch2.default)({ key: API_KEY, term: value }, function (data) {
	                _this.setState({
	                    videos: data,
	                    selectedVideo: data[0]
	                });
	        ...
	        value: function render() {
	            if (this.state.selectedVideo == null) {
	                return _react2.default.createElement(
	                    "div",
	                    null,
	                    _react2.default.createElement(_searchBar2.default, { onClick: this.videoSearch }),
	                    _react2.default.createElement(
	                        "div",
	                        null,
	                        "Busca algún video en la barra de búsqueda"
	                    )
	                );
	            }
	    ...
	    _createClass(SearchBar, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "button",
	                    { disabled: !this.state.inputValue, className: "btn btn-success", onClick: this.props.onClick.bind(null, this.state.inputValue) },
	                    "Click me"
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoListItem = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoItem = function (_React$Component) {
	    ...
	    function VideoItem() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(VideoItem).apply(this, arguments));
	    }

	    _createClass(VideoItem, [{
	        key: "render",
	        value: function render() {
	            var imageUrl = this.props.video.snippet.thumbnails.default.url;

	            return _react2.default.createElement(
	                "li",
	                { className: "list-group-item", onClick: this.props.onClick.bind(null, this.props.video) },
	                _react2.default.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoDetail = function (_React$Component) {
	    ...
	    function VideoDetail() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(VideoDetail).apply(this, arguments));
	    }
